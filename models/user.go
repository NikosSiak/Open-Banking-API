...
type User struct {
	...
	Accounts    map[string]*AccountTokens `bson:"accounts,omitempty" json:"-"`
...
func (u *User) AddAccount(name string, account *AccountTokens) {
	if u.Accounts == nil {
		u.Accounts = make(map[string]*AccountTokens)
	}
